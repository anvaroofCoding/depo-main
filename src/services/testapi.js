...
// 	// ✅ 401 yoki 403 bo‘lsa — foydalanuvchini login sahifasiga yo‘naltiramiz
// 	if (result?.error?.status === 401 || result?.error?.status === 403) {
// 		console.warn(
// 			'Token muddati tugagan yoki ruxsat yo‘q. Login sahifasiga yo‘naltirilmoqda...'
// 		)
// 		localStorage.removeItem('tokens')
// 		window.location.href = '/login' // agar boshqa sahifa bo‘lsa, shu yerda almashtirasan
// 	}
