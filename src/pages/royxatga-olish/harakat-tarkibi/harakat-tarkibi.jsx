      ...
      >
        <Form form={formAdd} layout="vertical" onFinish={handleSubmit}>
          ...
          <Form.Item
            name="holati"
            label="Holati"
            // rules={[{ required: true, message: "Holatini kiriting!" }]}
          >
            <Select placeholder="Holatini tanlang">
              <Option value="Soz_holatda">Soz holatda</Option>
              <Option value="Texnik_korikda">Texnik ko'rikda</Option>
              <Option value="Nosozlikda">Nosozlikda</Option>
            </Select>
          </Form.Item>
        </Form>
      </Modal>
